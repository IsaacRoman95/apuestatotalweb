<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Instagram -->
            <a href="https://www.instagram.com/apuestatotaloficial/" target="_blank">
                <button type="button" data-twe-ripple-init data-twe-ripple-color="light"
            ...
            <!-- Telegram -->
            <a href="https://t.me/SamuelIsaacRomanVelasquez" target="_blank">
                <button type="button" data-twe-ripple-init data-twe-ripple-color="light"
            ...
            <!-- Messenger -->
            <a href="https://m.me/apuestatotaloficial" target="_blank">
                <button type="button" data-twe-ripple-init data-twe-ripple-color="light"
            ...
            <!-- Whatsapp -->
            <a href="https://wa.me/51938785028" target="_blank">
                <button type="button" data-twe-ripple-init data-twe-ripple-color="light"
